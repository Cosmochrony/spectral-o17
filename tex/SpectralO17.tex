...
\begin{document}
  ...
  \paragraph{Keywords.}
    fibre-level admissibility, conjugate Weil blocks, pair observable, projection non-injectivity, Weil representation,
    Heisenberg Cayley graphs, Gram–Schmidt redundancy, projective capacity, exponent doubling, observable hierarchy
